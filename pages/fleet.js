  ...
  return (
    <div>
      <Head >
        ...
        <link rel="canonical" href="https://www.nautilusshipping.com/fleet" />
      ...
      <Container className="text-box">
        <h1 className="fs-2 heading d-lg-flex d-none">Minimizing Downtime and Maximizing Revenues for Ship</h1>
        <h2 className="fs-2 heading d-lg-flex d-none">Owners and Operators</h2>
        <h1 className="fs-2 heading d-flex d-lg-none">Minimizing Downtime and Maximizing Revenues for Ship Owners and Operators </h1>
