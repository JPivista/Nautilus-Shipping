...
<Row>
<Col sm={6}><p className="fs-6">We make this possible through a dedicated team of professionals both offshore and onboard. Our experienced team provides the above-mentioned services for most types of vessels. We are among the fastest growing ship managers in the region with 12 vessels of all types currently under management. These include bulkers, tankers, and container vessels.</p></Col>
...
<Col className="fs-6">Placing of insurance cover at competitive rates</Col>
</Row>
</Col>
<Col xs={6}>
<Row>
